...
// If an api-related request gets this far, then a matching route was not found
app.use(["/api/*", "/stripe/*", "/auth/*"], function (req, res, next) {
  throw new NotFound(req.originalUrl);
});

// Custom default, i.e., catch-all, error handler middleware
